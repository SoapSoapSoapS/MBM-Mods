...
namespace Trainer.DearImGui
{
    public class ImGuiPluginHook : MonoBehaviour
    {
        ...
        public static GameObject Create(string name)
        {
            ...
            var component = new ImGuiPluginHook(obj.AddComponent(UnhollowerRuntimeLib.Il2CppType.Of<ImGuiPluginHook>()).Pointer);
            
            return obj;
        }

        public ImGuiPluginHook(IntPtr ptr) : base(ptr)
        {
            instance = this;
        }
        ...
        private void Start()
        {
            ...
            /* 
            // ref: UnityNativeTool - Works in runtime but need to use an existing game plugin and replace it with StubLluiPlugin.dll. For Bloons I replaced: discord_game_sdk.dll
            ...
            */
            ...
            Tools.Il2CppCoroutine.Start(CallPluginAtEndOfFrames());
        }
